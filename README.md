...
python3 camera.py
```
The demo code will run and prompt you to select a camera you want to use: 
``` bash
The following cameras are available:
Camera 1: HD camera FaceTime
Camera 2: iPhone 14 camera
Input the camera index:
```
After entering a valid camera index, you can either pick between annotated feed or plain feed being displayed. 
``` bash
Do you want to run the demo? (y/n):
```
Aand, you're done! Enjoy the demo!
***
***Note:*** This project is not yet ready for deployment. It is still in the development phase.
